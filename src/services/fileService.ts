...
export const getMimeTypeAndIsText = (filename: string, type?: string) => {
  ...
  const textExts = [
    'txt', 'js', 'ts', 'jsx', 'tsx', 'mjs', 'cjs', 'html', 'htm', 'xhtml', 'css', 'scss', 'sass', 'less',
    'json', 'json5', 'jsonc', 'md', 'markdown', 'py', 'pyw', 'bat', 'cmd', 'ps1', 'vbs', 'sh', 'bash', 'zsh', 'fish',
    'java', 'kt', 'kts', 'c', 'cpp', 'cc', 'cxx', 'h', 'hpp', 'hxx', 'cs', 'go', 'rs', 'rb', 'erb', 'php', 'phtml',
    'pl', 'pm', 'lua', 'sql', 'r', 'dart', 'swift', 'scala', 'toml', 'ini', 'cfg', 'conf', 'yaml', 'yml', 'xml',
    'svg', 'log', 'env', 'gitignore', 'gitattributes', 'dockerfile', 'makefile', 'cmake', 'gradle', 'properties', 'codelert'
  ];
